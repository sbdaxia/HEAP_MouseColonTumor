...
filter.peaks <- readRDS("Datafiles/merged-peaks-filtered-09282019.rds")
```
...
prepareHOMERinput(kmer.results = hva.up.peaks.k7, 
                  ...
                  filename.tag = "merged.hva.up",
                  n.kmers = 50,
                  width = 15)

genomic.regions <- "Kmer/merged.hva.up-peaks-k7-windows.bed"
background.regions <- "Kmer/merged.hva.up-peaks-k7-windows-background.bed"
homerdir <- "Kmer/homer-denovo-output-merged.hva.up-peaks-k7"
...
mouse.mirnas <- c("miR-130b", "miR-4768", "miR-31", "miR-4469", "miR-4309")
...
pdf("PDF_figure/Merged_peak_motif_analysis/HOMER_HVA_upregulated.pdf",
    width = 6,
    height = 10)
plotHomerResults(hva.up.peaks.homer.res[[1]],
                 hva.up.peaks.homer.res[[2]], n.motifs = 5)
...
prepareHOMERinput(kmer.results = hvak.up.peaks.k7, 
                  ...
                  filename.tag = "merged.hvak.up",
                  n.kmers = 50,
                  width = 15)

genomic.regions <- "Kmer/merged.hvak.up-peaks-k7-windows.bed"
background.regions <- "Kmer/merged.hvak.up-peaks-k7-windows-background.bed"
homerdir <- "Kmer/homer-denovo-output-merged.hvak.up-peaks-k7"
dir.create(homerdir, showWarnings = FALSE)
homer.cmd <- sprintf("findMotifsGenome.pl %s mm10 %s -bg %s -len 8 -size given -rna -noweight -minlp -5 -nlen 2 -N 200000 -bits -p 10 -cache 1000 >.homer-output 2>.err.homer-output",
                     genomic.regions, homerdir, background.regions)
## Run in terminal
...
mouse.mirnas <- c("miR-27a/b", "miR-15/16/195/322/497", "let-7/miR-98", "miR-24", "miR-4707", "miR-17/20/93/106", "miR-193-3p", "hsa-miR-7-1", "miR-3941")
...
pdf("PDF_figure/Merged_peak_motif_analysis/HOMER_HVAK_upregulated.pdf",
    width = 6,
    height = 10)
plotHomerResults(hvak.up.peaks.homer.res[[1]],
                 hvak.up.peaks.homer.res[[2]], n.motifs = 8)
...
mouse.mirnas <- c("let-7/miR-98", "miR-29", "miR-17/20/93/106/519/526", "miR-200/429", "miR-194", "miR-24","miR-25/32/92/363/367", "miR-26", "miR-19", "hsa-miR-3183", "hsa-miR-603", "miR-147b/210", "hsa-miR-4661-5p")
